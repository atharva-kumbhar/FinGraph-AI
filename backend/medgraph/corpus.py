    ...
    def _sample_sec_chunks() -> list[SECChunk]:
        return [
            SECChunk(
                ...
                content="Apple Inc. (NASDAQ: AAPL) SEC Form 10-K reported total net sales of $391.04 billion for fiscal year 2025 (FY2025) across Products ($294.9B) and Services ($96.1B). Tim Cook serves as Chief Executive Officer.",
                source="Apple Inc.",
            ...
            SECChunk(
                ...
                content="Microsoft Corporation (NASDAQ: MSFT) SEC Form 10-K reported total annual revenue of $245.12 billion for fiscal year 2025 (FY2025), driven by Intelligent Cloud ($105.4B) and Productivity & Business Processes. Satya Nadella is Chairman and CEO.",
            ...
            SECChunk(
                ...
                content="ExxonMobil Corporation (NYSE: XOM) SEC Form 10-K reported total revenues and other income of $344.58 billion and net income of $36.0 billion for fiscal year 2025 (FY2025). Darren W. Woods serves as Chairman and CEO.",
            ...
            SECChunk(
                ...
                content="JPMorgan Chase & Co. (NYSE: JPM) SEC Form 10-K reported net interest income of $89.7 billion and consolidated net income of $57.1 billion for fiscal year 2025 (FY2025). Jamie Dimon serves as Chairman and CEO.",
                source="JPMorgan Chase & Co.",
                category="Form 10-K Annual Report",
                entities=["JPMorgan Chase", "Jamie Dimon", "Net Interest Income", "Net Income"],
            ),
            SECChunk(
                chunk_id="chunk_nvidia_10k_01",
                content="NVIDIA Corporation (NASDAQ: NVDA) SEC Form 10-K reported total annual revenue of $96.3 billion for fiscal year 2025 (FY2025), driven by Compute & Networking demand. Jensen Huang serves as Founder and CEO.",
            ...
            SECChunk(
                ...
                content="Amazon.com, Inc. (NASDAQ: AMZN) SEC Form 10-K reported Amazon Web Services (AWS) operating income of $35.3 billion for fiscal year 2025 (FY2025). Andy Jassy serves as President and CEO.",
            ...
            SECChunk(
                ...
                content="Tesla, Inc. (NASDAQ: TSLA) SEC Form 10-K reported total annual revenue of $96.77 billion for fiscal year 2025 (FY2025) across Automotive Sales and Energy Storage. Elon Musk serves as CEO.",
                source="Tesla, Inc.",
                category="Form 10-K Annual Report",
